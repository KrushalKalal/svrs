...
@section('title', config('app.name') . ' || Withdrawal Setting')

@section('content')
    <div class="content">
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h2 class="mb-1">Withdrawal Setting</h2>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Withdrawal Setting Update</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form id="WithdrawalSettingForm">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Minimum Withdrawal Amount (₹) <span
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Maximum Withdrawal Amount (₹) <span
                                    class="text-danger">*</span></label>
    ...
    <script>
        $('#WithdrawalSettingForm').submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "{{ route('admin.withdrawal.setting.update') }}",
                type: "POST",
                data: $(this).serialize(),
