...
@section('content')
    <div class="content">
        ...
        @if($pendingDeposits + $pendingWithdrawals + $pendingMembership + $pendingRewardClaims > 0)
            <div class="alert alert-warning d-flex flex-wrap gap-3 align-items-center mb-4">
                <i class="ti ti-bell"></i>
                <strong>Pending Actions:</strong>
                @if($pendingDeposits)
                    <a href="{{ route('admin.deposit.approval') }}" class="badge bg-danger text-decoration-none">
                        <i class="ti ti-arrow-down-circle me-1"></i>{{ $pendingDeposits }} Deposits
                    </a>
                @endif
                @if($pendingWithdrawals)
                    <a href="{{ route('admin.withdrawal.approval') }}" class="badge bg-warning text-dark text-decoration-none ">
                        <i class="ti ti-arrow-up-circle me-1"></i>{{ $pendingWithdrawals }} Withdrawals
                    </a>
                @endif
                @if($pendingMembership)
                    <a href="{{ route('admin.membership.approval') }}" class="badge bg-primary text-decoration-none ">
                        <i class="ti ti-id-badge me-1"></i>{{ $pendingMembership }} Memberships
                    </a>
                @endif
                @if($pendingRewardClaims)
                    <a href="{{ route('admin.reward.claims') }}" class="badge bg-success text-decoration-none ">
                        <i class="ti ti-trophy me-1"></i>{{ $pendingRewardClaims }} Reward Claims
                    </a>
                @endif
            </div>
        @endif
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ route('admin.member.list') }}" class="btn btn-sm btn-outline-primary w-100">View All</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold text-success">{{ $activeMembers }}</h3>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ route('admin.activate.member') }}" class="btn btn-sm btn-outline-success w-100">View
                            Active</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold text-warning">{{ $pendingMembers }}</h3>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ route('admin.id.activate') }}" class="btn btn-sm btn-outline-warning w-100">Activate
                            Now</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold text-info">{{ $referMembers }}</h3>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ route('admin.referral.reward.list') }}" class="btn btn-sm btn-outline-info w-100">View
                            Rewards</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card border-success shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 text-success">&#8377;{{ number_format($totalDeposits, 2) }}</h3>
                        <p class="text-muted mb-0 small">Total Deposits (All Time)</p>
                    </div>
                    <div class="card-footer bg-transparent border-0">
                        <a href="{{ route('admin.deposit.approval') }}"
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card border-danger shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 text-danger">&#8377;{{ number_format($totalWithdrawals, 2) }}</h3>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card border-primary shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 text-primary">&#8377;{{ number_format($totalMembership, 2) }}</h3>
                        <p class="text-muted mb-0 small">Membership Fees Collected</p>
                    </div>
                    <div class="card-footer bg-transparent border-0">
                        <a href="{{ route('admin.membership.approval') }}"
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card border-warning shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 text-warning">{{ number_format($totalReferralCoins, 4) }}</h3>
                        <p class="text-muted mb-0 small">SVRS Referral Coins Issued</p>
                    </div>
                    <div class="card-footer bg-transparent border-0">
                        <a href="{{ route('admin.referral.reward.list') }}"
        ...
        <div class="row mb-4">
            <div class="col-md-4 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2 text-primary">&#8377;{{ number_format($currentPrice, 4) }}</h3>
                        <p class="text-muted mb-0 small">Current SVRS Price</p>
                    </div>
                    <div class="card-footer bg-transparent border-0">
                        <a href="{{ route('admin.coin.chart') }}" class="btn btn-sm btn-outline-primary w-100">Coin
                            Chart</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body text-center">
                        <i class="ti ti-coins fs-2 text-warning"></i>
                        <h3 class="mt-2 text-warning">{{ number_format($totalSVRS, 4) }}</h3>
                        <p class="text-muted mb-0 small">Total SVRS in Circulation</p>
                        <small class="text-muted">&#8377;{{ number_format($totalSVRS * $currentPrice, 2) }} approx
                            value</small>
                    </div>
                    <div class="card-footer bg-transparent border-0">
                        <a href="{{ route('admin.coin.history') }}" class="btn btn-sm btn-outline-warning w-100">Coin
                            History</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="card shadow-sm h-100" style="border-color:#f0a500;">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mt-2" style="color:#f0a500;">{{ number_format($totalGoldCoins) }}</h3>
                        <p class="text-muted mb-0 small">Total G-Coins Approved</p>
                        <small class="text-muted">&#8377;{{ number_format($totalGoldCoins / 10, 2) }} INR value</small>
                    </div>
                    <div class="card-footer bg-transparent border-0">
                        <a href="{{ route('admin.reward.claims') }}" class="btn btn-sm btn-outline-secondary w-100">Reward
                            Claims</a>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0 text-success">&#8377;{{ number_format($adminWallet->balance ?? 0, 2) }}</h4>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ route('admin.my.wallet') }}" class="btn btn-sm btn-outline-success w-100">My Wallet</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0 text-warning">{{ number_format($adminCoinBal, 4) }}</h4>
                            <small class="text-muted">&#8377;{{ number_format($adminCoinBal * $currentPrice, 2) }}</small>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ route('admin.coin') }}" class="btn btn-sm btn-outline-warning w-100">Trade</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0 text-primary">{{ number_format($adminReferEarn, 4) }}</h4>
                ...
                <div class="card shadow-sm h-100" style="border-color:#f0a500;">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0" style="color:#f0a500;">{{ number_format($adminGoldWal->balance ?? 0) }}</h4>
                            <small
                                class="text-muted">&#8377;{{ number_format(($adminGoldWal->balance ?? 0) / 10, 2) }}</small>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ route('admin.reward.claims') }}" class="btn btn-sm btn-outline-secondary w-100">Gold
                            Rewards</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-7 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.deposit.approval') }}" class="btn btn-sm btn-outline-warning">View All</a>
                    </div>
                            ...
                            <table class="table table-sm table-hover mb-0">
                                ...
                                <tbody>
                                    @forelse($recentDeposits as $dep)
                                        <tr>
                                            <td>{{ $dep->user->full_name ?? '-' }}<br><small
                                                    class="text-muted">{{ $dep->user->member_code ?? '' }}</small></td>
                                            <td class="text-success fw-bold">&#8377;{{ number_format($dep->amount, 2) }}</td>
                                            <td><small>{{ $dep->created_at->format('d M h:i A') }}</small></td>
                                            <td><a href="{{ route('admin.deposit.approval') }}"
                ...
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body p-0">
                        <div class="list-group list-group-flush">
                            <a href="{{ route('admin.add.member') }}" class="list-group-item list-group-item-action py-2">
                                <i class="ti ti-user-plus me-2 text-primary"></i>Add New Member
                            </a>
                            <a href="{{ route('admin.id.activate') }}" class="list-group-item list-group-item-action py-2">
                                <i class="ti ti-user-check me-2 text-success"></i>Pending Activations
                                @if($pendingMembers)<span
                                class="badge bg-warning float-end">{{ $pendingMembers }}</span>@endif
                            </a>
                            <a href="{{ route('admin.membership.approval') }}"
                                class="list-group-item list-group-item-action py-2">
                                <i class="ti ti-id-badge me-2 text-info"></i>Membership Approvals
                                @if($pendingMembership)<span
                                class="badge bg-primary float-end">{{ $pendingMembership }}</span>@endif
                            </a>
                            <a href="{{ route('admin.deposit.approval') }}"
                                class="list-group-item list-group-item-action py-2">
                                <i class="ti ti-arrow-down-circle me-2 text-success"></i>Deposit Approvals
                                @if($pendingDeposits)<span
                                class="badge bg-danger float-end">{{ $pendingDeposits }}</span>@endif
                            </a>
                            <a href="{{ route('admin.withdrawal.approval') }}"
                                class="list-group-item list-group-item-action py-2">
                                <i class="ti ti-arrow-up-circle me-2 text-danger"></i>Withdrawal Approvals
                                @if($pendingWithdrawals)<span
                                class="badge bg-danger float-end">{{ $pendingWithdrawals }}</span>@endif
                            </a>
                            <a href="{{ route('admin.reward.claims') }}"
                                class="list-group-item list-group-item-action py-2">
                                <i class="ti ti-trophy me-2 text-warning"></i>Reward Claims
                                @if($pendingRewardClaims)<span
                                class="badge bg-success float-end">{{ $pendingRewardClaims }}</span>@endif
                            </a>
                            <a href="{{ route('admin.reports.financial') }}"
                                class="list-group-item list-group-item-action py-2">
                                <i class="ti ti-chart-bar me-2 text-secondary"></i>Financial Reports
                            </a>
                            <a href="{{ route('admin.coin.list') }}" class="list-group-item list-group-item-action py-2">
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.member.list') }}" class="btn btn-sm btn-outline-primary">View All</a>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-sm table-hover mb-0">
                        ...
                        <tbody>
                            @foreach($recentMembers as $m)
                                <tr>
                                    ...
                                    <td>{{ $m->full_name }}<br><small class="text-muted">{{ $m->email }}</small></td>
                                    ...
                                    <td>@if($m->is_refer_member)<span class="badge bg-success">Yes</span>@else<span
