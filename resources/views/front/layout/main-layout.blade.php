...
<body class="home-defi-1 header-fixed" data-magic-cursor="show">
    ...
    <script src="{{ asset('front/app/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('front/app/js/jquery.easing.js') }}"></script>
    <script src="{{ asset('front/app/js/app.js') }}"></script>
    <script src="{{ asset('front/app/js/count-down.js') }}"></script>
    <script src="{{ asset('front/app/js/aos.js') }}"></script>
    <script src="{{ asset('front/app/js/chart.js') }}"></script>
