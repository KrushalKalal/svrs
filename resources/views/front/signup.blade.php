                ...
                <div class="col-md-6">
                    <div class="sign-in__main">
                        <div class="top center">
                            <img id="site-logo" src="{{ asset('front/assets/images/logo/logo-main.png') }}" alt="Logo"
                                width="165" height="40">
                        ...
                        <form id="registerForm" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if($sponsor)
                                        {{-- Came via referral link — locked --}}
                                        <input type="text" class="form-control mb-0 bg-light fw-bold"
                                            value="{{ $sponsor->member_code }}" readonly>
                                        <input type="hidden" name="sponsor_id" value="{{ $sponsor->member_code }}">
                                        <small class="text-success">
                                            ✔ Sponsor: {{ $sponsor->first_name }} {{ $sponsor->last_name }}
                                        </small>
                                    @else
                                        {{-- Direct signup — can type sponsor code manually --}}
                    ...
                    <div class="sign-in__main">
                        ...
                        <div class="text-center">
                            @if($contact && $contact->qr_image)
                                <img src="{{ asset($contact->qr_image) }}" alt="QR Code" class="qr-placeholder img-fluid">
    ...
    @if(!$sponsor)
        $('#sponsorInput').on('blur', function () {
            ...
            $.ajax({
                ...
                type: "POST",
                data: { sponsor_id: code, _token: "{{ csrf_token() }}" },
