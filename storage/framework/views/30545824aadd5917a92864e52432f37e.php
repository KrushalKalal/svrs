...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-secondary d-flex align-items-center mb-4">
                            ...
                            <div>
                                ...
                                <?php echo e($authUser->first_name); ?> <?php echo e($authUser->last_name); ?>

                                <span class="badge bg-dark ms-2"><?php echo e($authUser->member_code); ?></span>
                            </div>
                        </div>
                        ...
                        <form id="addMemberForm" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="sponsor_id" value="<?php echo e($authUser->member_code); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="amount" id="amount" class="form-control mb-0"
                                        ...
                                        min="<?php echo e($deposit->min_amount ?? 200); ?>"
                                        max="<?php echo e($deposit->max_amount ?? 2000); ?>">
                                    <small class="text-muted">Min ₹<?php echo e($deposit->min_amount ?? 200); ?>, Max ₹<?php echo e($deposit->max_amount ?? 2000); ?></small>
                            ...
                            <div class="d-flex justify-content-between align-center mt-2">
                                <div>
                                    <a href="<?php echo e(route('admin.member.list')); ?>" class="btn btn-outline-secondary px-4">Cancel</a>
                                </div>
                                <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <?php if(isset($contact) && $contact->qr_image): ?>
                            <img src="<?php echo e(asset($contact->qr_image)); ?>" alt="QR Code" class="img-fluid mb-3" style="max-width:200px;">
    ...
    // Amount validation
    let minAmount = <?php echo e($deposit->min_amount ?? 200); ?>;
    let maxAmount = <?php echo e($deposit->max_amount ?? 2000); ?>;
    ...
    $('#addMemberForm').on('submit', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.add.member.store')); ?>",
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Qubeta\svrs\resources\views/admin/member/add_member.blade.php ENDPATH**/ ?>