                    ...
                    <div class="sign-in__main" style="height: fit-content;">
                        ...
                        <form id="adminLoginForm">
                            ...
                            <div class="form-check">
                                ...
                                <p>
                                    <a href="<?php echo e(route('admin.forgot.password')); ?>" class="link-danger">Forgot
                                        Password?</a>
                                </p>
                            </div>
                        ...
                        <div class="bottom center mt-3">
                            <p class="with">
                                Dont have an account ? <a href="<?php echo e(route('front.sign.up')); ?>">Sign up</a>
                            </p>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#adminLoginForm").on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.login.submit')); ?>",
                type: "POST",
                data: formData,
...
<?php /**PATH D:\xampp\htdocs\SVRS\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>