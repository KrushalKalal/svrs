            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h4 class="text-success">&#8377;<?php echo e(number_format($wallet->balance ?? 0, 2)); ?></h4>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h4 class="text-warning"><?php echo e(number_format($referralRewards->sum('reward_quantity'), 4)); ?></h4>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Qubeta\svrs\resources\views/member/reports/wallet_ledger.blade.php ENDPATH**/ ?>