...
<?php $__env->startSection('nav-title', 'Income Report'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="padding:16px 20px 0;">
        <div class="segment-ctrl" id="incomeTabs">
            <button class="active" onclick="switchIncome('l1',this)">Level 1 (<?php echo e($level1Rewards->count()); ?>)</button>
            <button onclick="switchIncome('l2',this)">Level 2 (<?php echo e($level2Rewards->count()); ?>)</button>
            <button onclick="switchIncome('l3',this)">Level 3 (<?php echo e($level3Rewards->count()); ?>)</button>
        </div>
    </div>
    ...
    <?php $__currentLoopData = [['l1', $level1Rewards, $totalLevel1], ['l2', $level2Rewards, $totalLevel2], ['l3', $level3Rewards, $totalLevel3]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$pid, $rewards, $total]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div id="panel<?php echo e(strtoupper($pid)); ?>" style="<?php echo e($pid === 'l1' ? '' : 'display:none;'); ?>padding:12px 20px 0;">
            ...
            <?php else: ?>
                    ...
                    <?php $__currentLoopData = $rewards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="list-row">
                            ...
                            <div class="list-body">
                                ...
                                <div class="sub"><?php echo e($rw->fromUser->member_code ?? '—'); ?> • <?php echo e($rw->percentage); ?>% • Base:
                                    <?php echo e(number_format($rw->base_quantity, 4)); ?> SVRS
                                </div>
                            ...
                            <div style="text-align:right;">
                                <div style="font-size:14px;font-weight:700;color:var(--green);">
                                    +<?php echo e(number_format($rw->reward_quantity, 4)); ?></div>
                ...
                <p style="font-size:13px;font-weight:700;color:var(--green);text-align:right;padding:10px 0 0;">Total:
                    +<?php echo e(number_format($total, 4)); ?> SVRS</p>
            <?php endif; ?>
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('member.layout.app-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Qubeta\svrs\resources\views/member/reports/income_report.blade.php ENDPATH**/ ?>