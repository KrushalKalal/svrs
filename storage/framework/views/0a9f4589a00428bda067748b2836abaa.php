...
<?php $__env->startSection('title', config('app.name') . ' || Referral Tree'); ?>

<?php $__env->startSection('content'); ?>
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Referral Tree &mdash; <?php echo e($member->full_name); ?></h2>
            <nav>
        ...
        <div>
            <a href="<?php echo e(route('admin.reports.income', $member->id)); ?>" class="btn btn-outline-success me-1">
        ...
        <div class="col-md-4">
            <div class="card border-primary text-center">
                <div class="card-body">
                    ...
                    <small class="text-success"><?php echo e($level1->where('is_refer_member',1)->where('status',1)->count()); ?> Refer Members</small>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-success text-center">
                <div class="card-body">
                    ...
                    <small class="text-success"><?php echo e($level2->where('is_refer_member',1)->where('status',1)->count()); ?> Refer Members</small>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-info text-center">
                <div class="card-body">
                    ...
                    <small class="text-success"><?php echo e($level3->where('is_refer_member',1)->where('status',1)->count()); ?> Refer Members</small>
                </div>
            </div>
        </div>
    </div>
            ...
            <ul class="tree">
                <li>
                    <div class="tree-node-box me-node">
                        ...
                        <small><?php echo e($member->member_code); ?></small>
                    </div>
                    <?php if($level1->count()): ?>
                    <ul>
                        ...
                        <li>
                            <div class="tree-node-box <?php echo e($l1->is_refer_member ? 'refer-node' : 'normal-node'); ?>">
                                ...
                                <?php else: ?><span class="badge bg-warning text-dark" style="font-size:9px;">Pending</span><?php endif; ?>
                            </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="tree-node-box <?php echo e($l2->is_refer_member ? 'refer-node' : 'normal-node'); ?>">
                                        <i class="ti ti-user me-1"></i><?php echo e($l2->full_name); ?><br>
                                        <small><?php echo e($l2->member_code); ?></small><br>
                                        <?php if($l2->status==1): ?><span class="badge bg-success" style="font-size:9px;">Active</span>
                                        <?php else: ?><span class="badge bg-warning text-dark" style="font-size:9px;">Pending</span><?php endif; ?>
                                    </div>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div class="tree-node-box <?php echo e($l3->is_refer_member ? 'refer-node' : 'normal-node'); ?>">
                                                <i class="ti ti-user me-1"></i><?php echo e($l3->full_name); ?><br>
                                                <small><?php echo e($l3->member_code); ?></small><br>
                                                <?php if($l3->status==1): ?><span class="badge bg-success" style="font-size:9px;">Active</span>
                                                <?php else: ?><span class="badge bg-warning text-dark" style="font-size:9px;">Pending</span><?php endif; ?>
                                            </div>
                                        </li>
    ...
    <ul class="nav nav-tabs mb-3">
        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#t1">Level 1 (<?php echo e($level1->count()); ?>)</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#t2">Level 2 (<?php echo e($level2->count()); ?>)</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#t3">Level 3 (<?php echo e($level3->count()); ?>)</a></li>
    </ul>
        ...
        <div class="tab-pane fade show active" id="t1">
            <div class="card"><div class="card-body"><div class="table-responsive">
                <table class="table table-bordered table-striped" id="tblT1">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $level1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php if($m->status==1): ?><span class="badge bg-success">Active</span><?php elseif($m->status==0): ?><span class="badge bg-danger">Inactive</span><?php else: ?><span class="badge bg-warning text-dark">Pending</span><?php endif; ?></td>
                                <td><?php if($m->is_refer_member): ?><span class="badge bg-success">Yes</span><?php else: ?><span class="badge bg-secondary">No</span><?php endif; ?></td>
                                <td>
                                    <a href="<?php echo e(route('admin.reports.wallet.ledger', $m->id)); ?>" class="btn btn-sm btn-outline-primary"><i class="ti ti-wallet"></i></a>
                                    <a href="<?php echo e(route('admin.reports.income', $m->id)); ?>" class="btn btn-sm btn-outline-success"><i class="ti ti-chart-bar"></i></a>
                                    <a href="<?php echo e(route('admin.reports.referral.tree', $m->id)); ?>" class="btn btn-sm btn-outline-info"><i class="ti ti-share"></i></a>
                                </td>
        ...
        <div class="tab-pane fade" id="t2">
            <div class="card"><div class="card-body"><div class="table-responsive">
                <table class="table table-bordered table-striped" id="tblT2">
                    <thead><tr><th>#</th><th>Name</th><th>Member Code</th><th>Sponsor</th><th>Status</th><th>Refer</th><th>Reports</th><th>Joined</th></tr></thead>
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $level2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($loop->iteration); ?></td>
                                <td><?php echo e($m->full_name); ?></td>
                                <td><span class="badge bg-primary"><?php echo e($m->member_code); ?></span></td>
        ...
        <div class="tab-pane fade" id="t3">
            <div class="card"><div class="card-body"><div class="table-responsive">
                <table class="table table-bordered table-striped" id="tblT3">
                    <thead><tr><th>#</th><th>Name</th><th>Member Code</th><th>Sponsor</th><th>Status</th><th>Refer</th><th>Reports</th><th>Joined</th></tr></thead>
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $level3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($loop->iteration); ?></td>
                                <td><?php echo e($m->full_name); ?></td>
                                <td><span class="badge bg-primary"><?php echo e($m->member_code); ?></span></td>
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Qubeta\svrs\resources\views/admin/reports/referral_tree.blade.php ENDPATH**/ ?>