...
<?php $__env->startSection('content'); ?>
                        ...
                        <form id="bankForm">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="account_name" class="form-control" value="<?php echo e($bankdetail->account_holder_name ?? ''); ?>">
                                    <small class="text-danger error-text account_name_error"></small>
                                </div>
                    
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Account Number</label>
                                    <input type="text" name="account_number" class="form-control" value="<?php echo e($bankdetail->account_number ?? ''); ?>">
                                    <small class="text-danger error-text account_number_error"></small>
                                </div>
                    
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">IFSC Code</label>
                                    <input type="text" name="ifsc_code" class="form-control" value="<?php echo e($bankdetail->ifsc_code ?? ''); ?>">
                                    <small class="text-danger error-text ifsc_code_error"></small>
                                </div>
                    
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Bank Name</label>
                                    <input type="text" name="bank_name" class="form-control" value="<?php echo e($bankdetail->ifsc_code ?? ''); ?>">
                                    <small class="text-danger error-text bank_name_error"></small>
                                </div>
                    
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Branch</label>
                                    <input type="text" name="branch_name" class="form-control" value="<?php echo e($bankdetail->branch_name ?? ''); ?>">
    ...
    <script>
        $('#bankForm').submit(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.bank.details')); ?>",
                type: "POST",
                data: $(this).serialize(),
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\SVRS\resources\views/admin/auth/profile.blade.php ENDPATH**/ ?>