...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SVRS Coin'); ?></title>
...
<body>
    ...
    <div id="app-shell">
        ...
        <nav id="top-nav">
            <?php if (! empty(trim($__env->yieldContent('nav-back')))): ?>
                <a href="<?php echo $__env->yieldContent('nav-back-url', 'javascript:history.back()'); ?>" class="nav-back">
            ...
            <?php else: ?>
                ...
                <div class="nav-avatar">
                    ...
                    <?php if($u->profile_image): ?>
                        <img src="<?php echo e(asset($u->profile_image)); ?>" alt="">
                    <?php else: ?>
                        <?php echo e(strtoupper(substr($u->first_name, 0, 1))); ?>

                    <?php endif; ?>
                </div>
            <?php endif; ?>

            <div class="nav-title"><?php echo $__env->yieldContent('nav-title', config('app.name', 'SVRS Coin')); ?></div>

            <div class="nav-actions">
                <?php echo $__env->yieldContent('nav-actions'); ?>

                <?php if (! (View::hasSection('hide-member-code'))): ?>
                    <div class="nav-member-code" onclick="copyMemberCode('<?php echo e(auth()->user()->member_code ?? ''); ?>')"
                        title="Copy member code">
                        <?php echo e(auth()->user()->member_code ?? ''); ?>

                        <i class="fa fa-copy"></i>
                    </div>
                <?php endif; ?>

                <a href="<?php echo e(route('member.logout')); ?>" class="nav-logout" title="Logout">
        ...
        <nav id="bottom-nav">
            ...
            <a href="<?php echo e(route('member.coin')); ?>" class="tab-item <?php echo e($coinActive ? 'active' : ''); ?>">
                <div class="tab-icon"><i class="fa fa-bitcoin-sign"></i></div>
                <span class="tab-label">Coin</span>
            </a>

            <a href="<?php echo e(route('member.dashboard')); ?>" class="tab-item <?php echo e($dashActive ? 'active' : ''); ?>">
                <div class="tab-icon"><i class="fa fa-th-large" style="font-size:17px;"></i></div>
                <span class="tab-label">Dashboard</span>
            </a>

            <a href="<?php echo e(route('member.my.wallet')); ?>" class="tab-item <?php echo e($walletActive ? 'active' : ''); ?>">
                <div class="tab-icon"><i class="fa fa-wallet"></i></div>
                <span class="tab-label">Wallet</span>
            </a>

            <a href="<?php echo e(route('member.profile')); ?>" class="tab-item <?php echo e($profileActive ? 'active' : ''); ?>">
...
</html><?php /**PATH D:\Qubeta\svrs\resources\views/member/layout/app-layout.blade.php ENDPATH**/ ?>