...
<?php $__env->startSection('nav-title', 'My Rewards'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="blue-card" style="padding:14px 16px;display:flex;align-items:center;gap:10px;">
            ...
            <div>
                <div style="font-size:14px;font-weight:700;">Active Refer Members (Level 1):
                    <?php echo e($eligibility['referral_count']); ?></div>
    ...
    <div style="padding:16px 20px 0;display:flex;flex-direction:column;gap:12px;">
        <?php $__currentLoopData = $eligibility['milestones']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="milestone-card <?php echo e($claimed ? 'completed' : ''); ?>">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;">
                    <div>
                        <p style="font-size:15px;font-weight:700;"><?php echo e($milestone['tier']->name); ?></p>
                        <p style="font-size:12px;color:var(--muted);">=
                            ₹<?php echo e(number_format($milestone['tier']->g_coins / 10, 2)); ?> INR value</p>
                    </div>
                    <div style="text-align:right;">
                        <p style="font-size:26px;font-weight:800;color:var(--gold);line-height:1;">
                            <?php echo e(number_format($milestone['tier']->g_coins)); ?></p>
                ...
                <div style="margin-bottom:8px;">
                    <div style="display:flex;justify-content:space-between;margin-bottom:5px;">
                        ...
                        <span style="font-size:12px;color:var(--muted);"><?php echo e($milestone['progress']); ?> /
                            <?php echo e($milestone['tier']->required_referrals); ?></span>
                    </div>
                    <div class="progress-app">
                        <div class="progress-fill <?php echo e($claimed ? 'green' : ''); ?>" style="width:<?php echo e($pct); ?>%;"></div>
                    </div>
                    <p style="font-size:11px;color:var(--muted);margin-top:4px;">Need
                        <?php echo e($milestone['tier']->required_referrals); ?> active refer members</p>
                </div>
                ...
                <?php elseif($canClaim): ?>
                    <button class="btn-app btn-gold claim-btn" style="padding:12px;" data-tier="<?php echo e($milestone['tier']->id); ?>"
                        data-name="<?php echo e($milestone['tier']->name); ?>" data-coins="<?php echo e(number_format($milestone['tier']->g_coins)); ?>">
                        <i class="fa fa-gift"></i> Claim <?php echo e(number_format($milestone['tier']->g_coins)); ?> G-Coins
                    </button>
                <?php elseif(isset($milestone['eligible']) && $milestone['eligible'] && !$canClaim): ?>
                    <div style="font-size:12px;color:var(--muted);padding:8px 0;">
                        <i class="fa fa-lock"
                            style="margin-right:6px;"></i><?php echo e($milestone['reason'] ?? 'Claim previous milestone first'); ?>
...
<?php echo $__env->make('member.layout.app-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Qubeta\svrs\resources\views/member/rewards/index.blade.php ENDPATH**/ ?>