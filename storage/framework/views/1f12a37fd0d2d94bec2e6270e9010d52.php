...
<?php $__env->startSection('title', config('app.name') . ' || Withdrawal Approval'); ?>
            ...
            if (status == 1) {
                ...
                Swal.fire({
                    ...
                    preConfirm: (amount) => {
                        ...
                        // ✅ AJAX Call
                        return $.ajax({
                            url: "<?php echo e(route('admin.withdrawal.change.status')); ?>",
                            type: "POST",
                            data: {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.post("<?php echo e(route('admin.withdrawal.change.status')); ?>", {
                            _token: "<?php echo e(csrf_token()); ?>",
                            id: id,
                            status: status
                        }, function(res) {
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Qubeta\svrs\resources\views/admin/withdrawal_approval.blade.php ENDPATH**/ ?>