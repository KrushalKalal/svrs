...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> | <?php echo $__env->yieldContent('title', 'Sign up'); ?></title>
                ...
                <div class="col-md-6">
                    <div class="sign-in__main">
                        <div class="top center">
                            <img id="site-logo" src="<?php echo e(asset('front/assets/images/logo/logo-main.png')); ?>" alt="Logo"
                                width="165" height="40">
                        ...
                        <form id="registerForm" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <?php if($sponsor): ?>
                                        ...
                                        <input type="text" class="form-control mb-0 bg-light fw-bold"
                                            value="<?php echo e($sponsor->member_code); ?>" readonly>
                                        <input type="hidden" name="sponsor_id" value="<?php echo e($sponsor->member_code); ?>">
                                        <small class="text-success">
                                            ✔ Sponsor: <?php echo e($sponsor->first_name); ?> <?php echo e($sponsor->last_name); ?>

                                        </small>
                                    <?php else: ?>
                                        
                                        <input type="text" name="sponsor_id" id="sponsorInput" class="form-control mb-0"
                                            placeholder="Enter Sponsor ID (optional)">
                                        <small class="error-text sponsor_id_error"></small>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="amount" class="form-control mb-0"
                                        placeholder="Enter Amount" min="<?php echo e($depositsetting->min_amount ?? 0); ?>"
                                        max="<?php echo e($depositsetting->max_amount ?? ''); ?>" id="amount">
                            ...
                            <div class="d-flex justify-content-between align-center">
                                <div class="bottom center">
                                    <p class="with">
                                        Already have an account? <a href="<?php echo e(route('admin.login')); ?>">Login</a>
                                    </p>
                                </div>
                    ...
                    <div class="sign-in__main">
                        ...
                        <div class="text-center">
                            <?php if($contact && $contact->qr_image): ?>
                                <img src="<?php echo e(asset($contact->qr_image)); ?>" alt="QR Code" class="qr-placeholder img-fluid">
                        ...
                        <div class="bank-details mt-4">
                            ...
                            <ul class="list-unstyled text-black">
                                ...
                                <li><strong>IFSC Code:</strong> <?php echo e($contact->ifsc_code ?? ''); ?></li>
                            ...
                            <?php if($depositsetting): ?>
                                <div class="alert alert-info py-2 mt-3">
                                    ...
                                    <?php if($depositsetting->max_amount): ?>
                                        | Maximum Deposit: ₹<?php echo e($depositsetting->max_amount); ?>
...
<script>
    ...
    // Sponsor ID check on blur (only when not pre-filled from referral link)
    <?php if(!$sponsor): ?>
        $('#sponsorInput').on('blur', function () {
            let code = $(this).val().trim();
            if (code === '') {
                $('.sponsor_id_error').text('').removeClass('text-danger text-success');
                return;
            }
            $.ajax({
                ...
                success: function (res) {
                    if (res.status) {
                        ...
                        $('.sponsor_id_error')
                            ...
                            .text('✖ ' + (res.message ?? 'Invalid Sponsor ID'));
                    }
                }
            });
        });
