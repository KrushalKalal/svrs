    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="footer d-sm-flex align-items-center justify-content-between border-top bg-white p-3">
                <p class="mb-0"><?php echo e(date('Y')); ?> &copy; SVRS.</p>
                <p>Designed &amp; Developed By <a href="https://qubetatechnolab.com/" class="text-primary">Qubeta
                        Technolab</a></p>
            </div>
        </div>
    </div>
...
</html><?php /**PATH D:\Qubeta\svrs\resources\views/admin/layout/main-layout.blade.php ENDPATH**/ ?>