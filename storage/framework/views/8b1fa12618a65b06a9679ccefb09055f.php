...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="d-flex justify-content-around mt-3">
                                ...
                                <div>
                                    ...
                                    <h2 class="fw-bold text-info mt-1">
                                        ₹ <?php echo e(number_format($pendingDeposit, 2)); ?>
                                ...
                                <?php if($pendingWithdraw > 0): ?>
                                    <div>
                                        ...
                                        <h2 class="fw-bold text-danger mt-1">
                                            ₹ <?php echo e(number_format($pendingWithdraw, 2)); ?>
                        ...
                        <div class="card-body text-center p-4">
                            ...
                            <?php if($depositsetting): ?>
                                <div class="alert alert-info py-2 mt-3 mb-0">
                                    <strong>Note:</strong>
                                    Minimum Deposit : ₹<?php echo e($depositsetting->min_amount); ?>
                            ...
                            <?php if($hasBankDetail): ?>
                                ...
                                <?php if($withdrawal): ?>
                                    <div class="alert alert-warning py-2 mt-3 mb-0">
                                        <strong>Note:</strong>
                                        Minimum Withdrawal : ₹<?php echo e($withdrawal->min_amount); ?>

                                        <?php if($withdrawal->max_amount): ?>
                                            | Maximum Withdrawal : ₹<?php echo e($withdrawal->max_amount); ?>

                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                            <?php else: ?>
                                <a href="<?php echo e(route('admin.profile')); ?>" class="btn btn-primary mt-2">
                    ...
                    <div class="row">
                        <div class="col-6 border-end">
                            ...
                            <div class="text-center mb-3">
                                <img src="<?php echo e(asset($contact->qr_image)); ?>" class="img-fluid rounded"
                            ...
                            <div class="bg-light p-3 rounded">
                                ...
                                <p class="mb-0"><strong>UPI ID :</strong> <?php echo e($contact->branch ?? ''); ?></p>
                            </div>
                            ...
                            <form id="addMoneyForm" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="amount" class="form-control mb-0"
                                        ...
                                        max="<?php echo e($depositsetting->max_amount ?? ''); ?>" id="addamounts">
    ...
    <script>
        ...
        $('#addMoneyForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.wallet.add.money')); ?>",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
    ...
    <script>
        ...
        $('#withdrawForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.wallet.withdraw.request')); ?>",
                type: "POST",
                data: $(this).serialize(),
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\SVRS\resources\views/admin/my_wallet.blade.php ENDPATH**/ ?>