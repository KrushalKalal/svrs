        ...
        $(document).on('click', '.tradeBtn', function() {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    return $.ajax({
                        url: "<?php echo e(route('admin.coin.trade')); ?>",
                        method: "POST",
                        data: {
...
<?php echo $__env->make('admin.layout.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\SVRS\resources\views/admin/coin_chart/chart.blade.php ENDPATH**/ ?>